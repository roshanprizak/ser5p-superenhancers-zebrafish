...
To identify superenhancers, we use the ROSE program from the Young lab. We cloned the repository on 23 April 2020, and provide that version as part of this package. 

`git clone https://github.com/stjude/ROSE`
